...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.0.0"
  WORKING_DIRECTORY "/home/ags/aaaa/build-cmake/libbpf/src/libbpf"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ags/aaaa/build-cmake/libbpf/src/libbpf'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ags/aaaa/build-cmake/libbpf/src/libbpf'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
